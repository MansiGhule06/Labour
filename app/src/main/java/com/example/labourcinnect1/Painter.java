...
public class Painter extends AppCompatActivity {
    ...
    String[] larray={"XYZ","ABC","QWER","UIOP"};
    String[] ldetails;
    String[] carray={"XYZ","ABC","QWER","UIOP"};
    String[] cdetails;
    ImageButton back;
    String info;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (info.equals("contractor")) {
                    intent=new Intent(Painter.this,ContractorHomepage.class);
                }
                else if(info.equals("labour"))
                {
                    intent=new Intent(Painter.this,LabourHomepage.class);
                }
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                intent = new Intent(Painter.this, MemberDetailsActivity.class);
