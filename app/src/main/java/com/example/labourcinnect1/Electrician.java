    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (info.equals("contractor")) {
                    intent=new Intent(Electrician.this,ContractorHomepage.class);
                }
                else if(info.equals("labour"))
                {
                    intent=new Intent(Electrician.this,LabourHomepage.class);
                }
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                intent = new Intent(Electrician.this, MemberDetailsActivity.class);
